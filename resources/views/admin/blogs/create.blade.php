...
@if(Route::currentRouteName() == "admin_blogs_create")
    @section('content-title', 'New Blog')
@elseif(Route::currentRouteName() =="admin_blogs_edit")
    @section('content-title', 'Update Blog')
@endif
    ...
    <div class="form-page">
        ...
        <main class="form-page-content">
            <form id="settings_form" role="form"
                  action="
               @if(Route::currentRouteName() == "admin_blogs_create")
               {{route("admin_blogs_store")}}
               @elseif(Route::currentRouteName() =="admin_blogs_edit")
               {{route("admin_blogs_update",['id'=>$blogData->id])}}
               @endif"
                  method="post"
                ...
                <div class="form_box">
                    ...
                    <div class="nice-form-group">
                        ...
                        <input type="text" placeholder="Title" name="title"
                               value="@if(isset($blogData->title)){{$blogData->title}}@endif"/>
                    </div>

                    <div class="nice-form-group">
                        <label>Subject</label>
                        <input type="text" placeholder="Subject" name="subject"
                               value="@if(isset($blogData->subject)){{$blogData->subject}}@endif"/>
                    </div>

                    <div class="nice-form-group">
                        <label>Keywords</label>
                        <input type="text" placeholder="Keywords" name="keywords"
                               value="@if(isset($blogData->keywords)){{$blogData->keywords}}@endif"/>
                    </div>

                    <div class="nice-form-group">
                        <label>Description</label>
                        @if(isset($blogData->description))
                            <textarea rows="5" placeholder="" name="description">{!! $blogData->description !!}
                            </textarea>
                        @else
                    ...
                    <div class="nice-form-group">
                        ...
                        <div class="uploaded-img" style="background-image: url('{{\Illuminate\Support\Facades\Storage::url($blogData->image)}}')"></div>
                        @endif
