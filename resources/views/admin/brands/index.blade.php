        ...
        <div class="container-fluid">
            ...
            <div class="flex-container mt-3" style="display: flex">
                ...
                @include("admin.components.verticalFilter",[
                    'filter_header'=>"<strong>".$brandsList->count()."</strong> blogs listed",
                ...
                <div class="table_with_filter ">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover text-nowrap" id="stockTable">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 10%; position: relative">Name
                                    </th>
                                ...
                                <div class="table-container" id="table-container">
                                    ...
                                    @foreach($brandsList as $brand)
                                        <tr class="table-item" id="{{$brand->id}}">
                                            <td>{{$brand->id}}</td>
                                            <td class="value_name">@isset($brand->name)
                                                    {{$brand->name}}
                                                @else
                                                    ---
                                                @endisset</td>
                                            <td class="value_description">@isset($brand->description)
                                                    {{Str::of($brand->description)->limit(30)}}
                                                @else
                                                    ---
                                                @endisset</td>
                                            <td class="value_created_date">@isset($brand->created_at)
                                                    {{\Carbon\Carbon::parse($brand->created_at)}}
                                                @else
                                                    ---
                                                @endisset</td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{route('admin_brands_edit',['id'=>$brand->id])}}"
                                            ...
                                            <td>
                                                <a href="{{route('admin_brands_destroy',['id'=>$brand->id])}}"
                        ...
                        <div class="card-footer">
                            ...
                            'openDirectly' => [true],
                            'card_item' => ['New Brand'],
                            'card_item_url' => [route('admin_brands_create')]
                        ])
