    ...
    <div class="form-page">
        ...
        <main class="form-page-content">
            <form id="settings_form" role="form"
                  action="
               @if(Route::currentRouteName() == "admin_products_create")
               {{route("admin_products_store")}}
               @elseif(Route::currentRouteName() =="admin_products_edit")
               {{route("admin_products_update",['id'=>$productData->id])}}
               @endif"
                  method="post"
                ...
                <div class="form_box">
                    ...
                    <div class="nice-form-group">
                        ...
                        <input type="text" placeholder="Name" name="name"
                               value="@if(isset($productData->name)){{$productData->name}}@endif"/>
                    </div>
                    ...
                    <div class="nice-form-group">
                        ...
                        <select name="type_id">
                            <option value="1" @if(isset($productData->type_id)) @if($productData->type_id == 1)  selected @endif @endif>MDR</option>
                            <option value="2" @if(isset($productData->type_id)) @if($productData->type_id == 2)  selected @endif @endif>Controllers</option>
                            <option value="3" @if(isset($productData->type_id)) @if($productData->type_id == 3)  selected @endif @endif>Diverters and sortation modules</option>
                        </select>
                    </div>
                    ...
                    <div class="nice-form-group">
                        ...
                        <input type="text" placeholder="Keywords" name="keywords"
                               value="@if(isset($productData->keywords)){{$productData->keywords}}@endif"/>
                    </div>

                    <div class="nice-form-group">
                        <label>Description</label>
                        @if(isset($productData->description))
                            <textarea rows="5" placeholder="" name="description">{!! $productData->description !!}
                            </textarea>
                        @else
                    ...
                    <div class="nice-form-group">
                        ...
                        @if(isset($brandData->image))
                            <div class="uploaded-img"
                                 style="background-image: url('{{\Illuminate\Support\Facades\Storage::url($brandData->image)}}')"></div>
                        @endif
