        ...
        <div class="container-fluid">
            ...
            <div class="flex-container mt-3" style="display: flex">
                ...
                @include("admin.components.verticalFilter",[
                    'filter_header'=>"<strong>".$productList->count()."</strong> blogs listed",
                ...
                <div class="table_with_filter ">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover text-nowrap" id="stockTable">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 10%; position: relative">Brand
                                    </th>
                                ...
                                <div class="table-container" id="table-container">
                                    ...
                                    @foreach($productList as $product)
                                        <tr class="table-item" id="{{$product->id}}">
                                            <td>{{$product->id}}</td>
                                            <td class="value_name">@isset($product->name)
                                                    {{$product->name}}
                                                @else
                                                    ---
                                                @endisset</td>
                                            <td class="value_name">@isset($product->name)
                                                ...
                                                @else
                                                    ---
                                                @endisset</td>
                                            <td class="value_description">@isset($product->description)
                                                    {{Str::of($product->description)->limit(30)}}
                                                @else
                                                    ---
                                                @endisset</td>
                                            <td class="value_created_date">@isset($product->created_at)
                                            ...
                                            <td>
                                                <a href="{{route('admin_products_edit',['id'=>$product->id])}}"
                                            ...
                                            <td>
                                                <a href="{{route('admin_products_destroy',['id'=>$product->id])}}"
                        ...
                        <div class="card-footer">
                            ...
                            'openDirectly' => [true],
                            'card_item' => ['New Product'],
                            'card_item_url' => [route('admin_products_create')]
                            ])
